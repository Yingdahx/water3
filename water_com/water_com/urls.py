...
urlpatterns = [
    ...
    path('fkyj/', views.fkvj),
    path('grzx/', views.grzx),
    path('index/', views.index),
    path('sbgl/', views.sbgl),
    path('summary/', views.summary),
    path('xjjh_increase/', views.xjjh_increase),
    path('xjjh_modify/', views.xjjh_modify),
    path('xjjh/', views.xjjh),
    path('xjrl/', views.xjrl),
    path('yhcl/', views.yhcl),
